...
num7 = Button(aken, text="7", font="Tahoma 12", command=num7, width=4)
num7.grid(row=2, column=1, padx= 2, pady= 2)
num4 = Button(aken, text="4", font="Tahoma 12", command=num4, width=4)
num4.grid(row=3, column=1, padx= 2, pady= 2)
num1 = Button(aken, text="1", font="Tahoma 12", command=num1, width=4)
num1.grid(row=4, column=1, padx= 2, pady= 2)
num0 = Button(aken, text="0", font="Tahoma 12", command=num0, width=4)
num0.grid(row=5, column=1, padx= 2, pady= 2)
num8 = Button(aken, text="8", font="Tahoma 12", command=num8, width=4)
num8.grid(row=2, column=2, padx= 2, pady= 2)
num5 = Button(aken, text="5", font="Tahoma 12", command=num5, width=4)
num5.grid(row=3, column=2, padx= 2, pady= 2)
num2 = Button(aken, text="2", font="Tahoma 12", command=num2, width=4)
num2.grid(row=4, column=2, padx= 2, pady= 2)
coma = Button(aken, text=",", font="Tahoma 12", command=coma, width=4)
coma.grid(row=5, column=2, padx= 2, pady= 2)
num9 = Button(aken, text="9", font="Tahoma 12", command=num9, width=4)
num9.grid(row=2, column=3, padx= 2, pady= 2)
num6 = Button(aken, text="6", font="Tahoma 12", command=num6, width=4)
num6.grid(row=3, column=3, padx= 2, pady= 2)
num3 = Button(aken, text="3", font="Tahoma 12", command=num3, width=4)
num3.grid(row=4, column=3, padx= 2, pady= 2) 
equal = Button(aken, text="=", font="Tahoma 12", command=equal, width=4)
equal.grid(row=5, column=3, padx= 2, pady= 2)
divide = Button(aken, text="/", font="Tahoma 12", command=divide, width=4)
divide.grid(row=2, column=4, padx= 2, pady= 2)
times = Button(aken, text="*", font="Tahoma 12", command=times, width=4)
times.grid(row=3, column=4, padx= 2, pady= 2)
minus = Button(aken, text="-", font="Tahoma 12", command=minus, width=4)
minus.grid(row=4, column=4, padx= 2, pady= 2)
add = Button(aken, text="+", font="Tahoma 12", command=add, width=4)
